...
public class WindowsProcessMonitor implements Runnable
{
	private Thread myThread = null;
	private boolean running = false;
	public static final String WIN_PROCESS_INFO = "tasklist /v ";
	public int finalExitValue = 0;
	private int time = 0;
	private Start toFeed = null;
	
	public WindowsProcessMonitor(int timeout)
	{
		time = timeout;
	...
	{
		WindowsProcessMonitor myMonitor = new WindowsProcessMonitor(2000);
	}
}
